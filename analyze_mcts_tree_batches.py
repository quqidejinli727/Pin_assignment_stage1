...
def _net_active_pin_count(net: Net, skipped_pin_names: set[str]) -> int:
    return sum(1 for pin in net.pins if pin.full_name not in skipped_pin_names)
...
def analyze_batches(
    ...
    while True:
        ...
        for seed_group in homology.unassigned_groups():
            ...
            for net in nets:
                active_pin_count = _net_active_pin_count(net, skipped_pin_names)
