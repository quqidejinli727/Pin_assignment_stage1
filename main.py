...
def run_pipline(config: RunConfig | None = None) -> Path:
    ...
    solver = AssignmentSolver(
        ...
        mcts_enable_inplace_simulation_state=config.mcts_enable_inplace_simulation_state,
        mcts_enable_assignment_location_cache=config.mcts_enable_assignment_location_cache,
